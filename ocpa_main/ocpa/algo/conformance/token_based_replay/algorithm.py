import ocpa_main.ocpa.algo.conformance.token_based_replay.variants.flattened_replay as flattened_replay
import ocpa_main.ocpa.algo.conformance.token_based_replay.variants.object_centric_replay as object_centric_replay
