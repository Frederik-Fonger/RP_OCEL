...
from ocpa_main.ocpa.algo.conformance.token_based_replay.utils import log_ocpa2pm4py as log_converter
from ocpa_main.ocpa.algo.conformance.token_based_replay.utils import pn_ocpa2pm4py as pn_converter
